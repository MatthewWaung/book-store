...
func AddOrder(order *model.Order) error {
	sql := "insert into order(id,create_time,total_count,total_amount,state,user_id) values (?,?,?,?,?,?)"
...
func GetOrders() ([]*model.Order, error) {
	sql := "select id,create_time,total_count,total_amount,state,user_id from order" // sql
...
func GetOrderByUserID(userID int) ([]*model.Order, error) {
	sql := "select id,create_time,total_count,total_amount,state,user_id from order where user_id=?"
